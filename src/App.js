...
const Inicio = React.lazy(() => import("./components/pages/Inicio"));
// prebuilt pages
...
function App() {
  const [isLoggedIn, setIsLoggedIn] = useState(true); // Estado de autenticación
  return (
    <Router basename={'/'}>
      <Suspense fallback={<div></div>}>
        ...
        <Switch>
          ...
          <Route path="/prebuilt-pages/dprebuilt-pages/default-loginefault-register" component={Defaultregister} />
          ...
          <Route path="/dashboard/client-management">
                {isLoggedIn ? <Clientmanagement /> : <Redirect to="/login" />}
            </Route>
          ...
          <Route path="/" component={Defaultlogin} />
