                    ...
                    <Accordion className="accordion ms-main-aside fs-14" id="side-nav-accordion">
                        ...
                        <li className="menu-item">
                            <Accordion.Toggle as={NavLink} variant="link" eventKey="1" className="has-chevron">
                                <span><i className="fas fa-stethoscope" />Medico</span>
                            </Accordion.Toggle>
                            <Accordion.Collapse eventKey="1">
                                <ul>
                                    <li> <Link to="/doctor/add-doctor">Agregar medico</Link> </li>
                                    <li> <Link to="/doctor/doctor-list">Ver medicos</Link> </li>
                                </ul>
                            </Accordion.Collapse>
                        </li>
                        {/* Doctor */}
                        ...
                        <li className="menu-item">
                            <Accordion.Toggle as={NavLink} variant="link" eventKey="2" className="has-chevron">
                                <span><i className="fas fa-user" />Pacientes</span>
                            </Accordion.Toggle>
                            <Accordion.Collapse eventKey="2">
                                <ul>
                                    <li> <Link to="/patient/add-patient">Agregar Paciente</Link> </li>
                                    <li> <Link to="/patient/patient-list">Listar Paciente</Link> </li>
                                </ul>
                            </Accordion.Collapse>
                        </li>
                        {/* Patient */}
                        ...
                        <li className="menu-item">
                            <Accordion.Toggle as={NavLink} variant="link" eventKey="4" className="has-chevron">
                                <span><i className="fas fa-list-alt" />Horario del médico</span>
                            </Accordion.Toggle>
                            <Accordion.Collapse eventKey="4">
                                <ul>
                                    <li> <Link to="/doctor-schedule/add-schedule">Horario del médico</Link> </li>
                        ...
                        <li className="menu-item">
                            <Accordion.Toggle as={NavLink} variant="link" eventKey="5" className="has-chevron">
                                <span><i className="far fa-check-square" />Citas</span>
                            </Accordion.Toggle>
                            <Accordion.Collapse eventKey="5">
                                <ul>
                                    <li> <Link to="/appointment/add-appointment">Agregar Cita</Link> </li>
                                    <li> <Link to="/appointment/appointment-list">Ver citas</Link> </li>
                                </ul>
                            </Accordion.Collapse>
                        </li>
                        {/* Appointment */}
